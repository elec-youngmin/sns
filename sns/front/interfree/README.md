...
| 요청 문자열                           | 동작                                          |
| ------------------------------------- | --------------------------------------------- |
| http://interfree.co.kr/post/23        | 23번 포스트 페이지로 라우팅                   |
| http://interfree.co.kr/user/3         | 3번 유저의 페이지로 라우팅                    |
| http://interfree.co.kr/hashtag/댕댕이 | 댕댕이 해시태그를 가진 포스트를 라우팅        |
| http://interfree.co.kr/search/댕댕이  | 댕댕이 포스트를 검색해 댕댕이 포스트를 라우팅 |

예를 들어 요청 url이 http://interfree.co.kr/post/23 라고 가정하면
